...
from agents.daily_quick_pipeline import DailyQuickPipeline, ContentRequest
from agents.hybrid_workflow_manager import HybridWorkflowManager, ContentPipelineType
...
def generate_newsletter(config: Dict[str, Any]):
    ...
    try:
        ...
        if st.session_state.selected_pipeline == 'daily_quick':
            ...
            generation_result = workflow_result
...
def display_newsletter_content(content: Dict[str, Any]):
    ...
    if content:
        ...
        if st.session_state.selected_pipeline == 'daily_quick':
            ...
            with tabs[0]:
                st.markdown(content.get('newsletter_content', 'No content generated'))
...
def publish_newsletter(content: Dict[str, Any], topic: str):
    ...
    try:
        ...
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(content.get('newsletter_content', ''))
