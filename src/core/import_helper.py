...
def check_system_health() -> Dict[str, Any]:
    ...
    try:
        health_report["core_modules"]["query_llm"] = safe_import_core() is not None
    except Exception as e:
    ...
    try:
        health_report["core_modules"]["scrapers"] = safe_import_scrapers() is not None
    except Exception as e:
        health_report["issues"].append(f"Scraper module import failed: {e}")
        health_report["core_modules"]["scrapers"] = False
    
    try:
        health_report["core_modules"]["storage"] = safe_import_storage() is not None
    except Exception as e:
