...
class NewsletterGeneratorError(NewsletterError):
    """Base exception for newsletter generator errors (alias for NewsletterError)."""
    pass
...
class ScrapingError(NewsletterError):
    """Raised when there's a scraping operation error."""
    pass
