...
from .base import StorageProvider, StorageConfig, DocumentMetadata, SearchResult, StorageStats, DataType
...
class MemoryStorageProvider(StorageProvider):
    ...
    def add_document(self, content: str, metadata: DocumentMetadata) -> str:
        ...
        try:
            ...
            # Generate embedding (simplified - in practice you'd use the embedding model)
    ...
    def search(self, query: str, filters: Optional[Dict[str, Any]] = None, 
        ...
        try:
            ...
            if cached_results:
                self.stats.cache_hit_rate = min(1.0, self.stats.cache_hit_rate + 0.1)
    ...
    def get_document(self, doc_id: str) -> Optional[Tuple[str, DocumentMetadata]]:
        ...
        try:
            ...
            if doc_id in self.documents:
                ...
                # Cache the result
                self._cache_set(cache_key, {"content": content, "metadata": metadata})
    ...
    def get_stats(self) -> StorageStats:
        ...
        self.stats.total_chunks = len(self.documents)  # In memory, chunks = documents
    ...
    def backup(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Memory storage backup created with {len(self.documents)} documents")
    ...
    def migrate(self, target_provider: 'StorageProvider') -> bool:
        ...
        try:
            ...
            logger.info(f"Migrated {migrated_count} documents to target provider")
    ...
    def _generate_simple_embedding(self, text: str) -> List[float]:
        ...
        # This is a very simplified embedding - in practice you'd use a proper model
        import hashlib
    ...
    def _calculate_similarity(self, embedding1: List[float], embedding2: List[float]) -> float:
        ...
        dot_product = sum(embedding1[i] * embedding2[i] for i in range(min_len))
